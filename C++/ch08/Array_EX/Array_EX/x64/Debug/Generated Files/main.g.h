...
namespace winrt::ArrayEX::implementation
{
    ...
    struct __declspec(empty_bases) main_base : implements<D, ArrayEX::main, composing, winrt::Windows::UI::Xaml::Controls::IPageOverrides, winrt::Windows::UI::Xaml::Controls::IControlOverrides, winrt::Windows::UI::Xaml::Controls::IControlOverrides6, winrt::Windows::UI::Xaml::IFrameworkElementOverrides, winrt::Windows::UI::Xaml::IFrameworkElementOverrides2, winrt::Windows::UI::Xaml::IUIElementOverrides, winrt::Windows::UI::Xaml::IUIElementOverrides7, winrt::Windows::UI::Xaml::IUIElementOverrides8, winrt::Windows::UI::Xaml::IUIElementOverrides9, I...>,
...
namespace winrt::ArrayEX::factory_implementation
{
    ...
    {
        using instance_type = ArrayEX::main;
...
#if defined(WINRT_FORCE_INCLUDE_MAIN_XAML_G_H) || __has_include("main.xaml.g.h")
#include "main.xaml.g.h"
#else

namespace winrt::ArrayEX::implementation
{
    template <typename D, typename... I>
    using mainT = main_base<D, I...>;
}
